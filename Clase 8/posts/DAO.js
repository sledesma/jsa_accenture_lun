...
const postObject = (postData) => ({
  get userId() { return postData.userId },
  get id() { return postData.id },
  get title() { return postData.title },
  get body() { return postData.body }
});
...
const userObject = (userData) => ({
  ...
  get name() { return userData.name },
  get username() { return userData.username },
  get email() { return userData.email },
  get address() { return userData.address },
  get phone() { return userData.phone },
  get website() { return userData.website },
  get company() { return userData.company }
});
